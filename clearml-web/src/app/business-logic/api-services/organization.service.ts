...
import {OrganizationGetProjectWorkloadsRequest} from '~/business-logic/model/organization/organizationGetProjectWorkloadsRequest';
import {OrganizationGetProjectWorkloadsResponse} from '~/business-logic/model/organization/organizationGetProjectWorkloadsResponse';
...
export class ApiOrganizationService {
   ...
   */
  public organizationGetProjectWorkloads(request: OrganizationGetProjectWorkloadsRequest, options?: ApiOptions): Observable<any> {
    return this.apiRequest.post<OrganizationGetProjectWorkloadsResponse>(`${this.basePath}/organization.get_project_workloads`,
      request,
      {
