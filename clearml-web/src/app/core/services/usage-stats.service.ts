      ...
      this.store.select(selectPromptUser)
        ...
        .subscribe(() => {
          const dialogRef = this.dialog.open(ConfirmDialogComponent,
            {
              data: {
                title: 'Help us improve TonOps',
                body: `Please allow the TonOps server to send anonymous usage metrics so we can better understand how TonOps is being used and make it even better.<BR>
