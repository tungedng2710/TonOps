...
class User(DbModelMixin, AuthDocument):
    ...
    # Local IAM fields. They are optional so existing installations and service
    # identities remain backwards compatible.
    username = StringField()
    password_hash = StringField()
    status = StringField(choices=("active", "disabled"), default="active")
    ...
    auth_version = IntField(default=1)
