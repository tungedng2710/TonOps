...
DEVELOPMENT_DEFAULT_SHELL_BINARY_PATH = EnvEntry("CLEARML_DEVELOPMENT_DEFAULT_SHELL_BINARY_PATH", type=str)
BLOCK_PICKLED_ARTIFACTS = EnvEntry("CLEARML_BLOCK_PICKLED_ARTIFACTS", type=bool)
