...
class PatchedMatplotlib:
    ...
    class _PatchWarnings:
        ...
        def warn(self, text: str, *args: Any, **kwargs: Any) -> None:
            raise ValueError(text)

        def __getattr__(self, item: str) -> Any:
            def bypass(*_: Any, **__: Any) -> None:
                pass

            return bypass

    @staticmethod
    def force_report_as_image(force: bool) -> None:
        """
    ...
    @staticmethod
    def _update_matplotlib_image_support() -> None:
    ...
    @staticmethod
    def _update_matplotlib_version() -> None:
    ...
    @staticmethod
    def _update_plotly_renderers() -> bool:
    ...
    @staticmethod
    def _get_global_image_counter_limit() -> int:
    ...
    @staticmethod
    def update_current_task(task: Any) -> None:
    ...
    @staticmethod
    def patched_imshow(*args: Any, **kw: Any) -> Any:
        ...
        try:
            ...
            if stored_figure:
                stored_figure._trains_is_imshow = (
                    1
                    if getattr(stored_figure, "_trains_is_imshow", None) is None
    ...
    @staticmethod
    def patched_savefig(self, *args: Any, **kw: Any) -> Any:
    ...
    def report_figure(
        ...
        figure: Any,
        iter: int,
        force_save_as_image: bool = False,
        report_as_debug_sample: bool = False,
        reporter: Any = None,
        logger: Any = None,
    ) -> None:
    ...
    def _report_figure(
        force_save_as_image: bool = False,
        report_as_debug_sample: bool = False,
        stored_figure: Any = None,
        set_active: bool = True,
        specific_fig: Any = None,
        title: str = None,
        series: str = None,
        iter: int = None,
        reporter: Any = None,
        ...
        try:
            ...
            if (
                not report_as_debug_sample
                and not force_save_as_image
                and mpl_fig
                and getattr(mpl_fig, "axes", None)
                and len(mpl_fig.axes) > 1
            ):
                force_save_as_image = True
            ...
            if report_as_debug_sample:
                fig_dpi = None
                image_format = (
                    force_save_as_image if force_save_as_image and isinstance(force_save_as_image, str) else "jpeg"
                )
                ...
                try:
                    ...
                    def our_mpl_to_plotly(
                        ...
                        def process_tick_text(
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    def convert_latex_math_powers_to_html(
                                        text: str,
                                    ) -> str:
                                        # noinspection PyBroadException
                                        try:
                                            if (
                                                not text
                                                or not text.startswith("$\\mathdefault{")
                                    ...
                                    plotly_renderer.plotly_fig["layout"][_axis].update(
                                        {
                                            "ticktext": [
                                                convert_latex_math_powers_to_html(t.get_text()) for t in ticks
                                            ],
                        ...
                        process_tick_text(
                            list(plotly_renderer.current_mpl_ax.get_xticklabels()),
                            ("xaxis", "xaxis0", "xaxis1"),
                            0,
                        )
                        process_tick_text(
                            list(plotly_renderer.current_mpl_ax.get_yticklabels()),
                            ("yaxis", "yaxis0", "yaxis1"),
                            1,
                        )
                        # noinspection PyBroadException
                        ...
                        # noinspection PyBroadException
                        try:
                            if plotly_renderer.plotly_fig.get("layout", {}).get(
                                "showlegend"
                            ) and plotly_renderer.plotly_fig.get("data"):
                                # the legend names is the upper half of the data points:
                                lines_ = plotly_renderer.plotly_fig["data"]
                                half_mark = len(lines_) // 2
                                if len(lines_) % 2 == 0 and all(
                                    not ln.get("x") and not ln.get("y") for ln in lines_[half_mark:]
                                ):
    ...
    @staticmethod
    def _enforce_unique_title_per_iteration(title: str, last_iteration: int) -> str:
        """
        ...
        if title in PatchedMatplotlib._last_iteration_plot_titles:
            ...
            (
                title_last_iteration,
                title_counter,
            ) = PatchedMatplotlib._last_iteration_plot_titles[title]
        ...
        PatchedMatplotlib._last_iteration_plot_titles[base_title] = (
            title_last_iteration,
            title_counter,
        )
    ...
    @staticmethod
    def _get_output_figures(
        stored_figure: "matplotlib.figure.Figure", all_figures: bool
    ...
    @staticmethod
    def __patched_draw_all(*args: Any, **kwargs: Any) -> Any:
    ...
    @staticmethod
    def ipython_post_execute_hook() -> None:
        # noinspection PyBroadException
        try:
            from matplotlib import _pylab_helpers
