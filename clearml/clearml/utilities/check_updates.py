...
class CheckPackageUpdates:
    ...
    @classmethod
    def check_new_package_available(cls, only_once: bool = False) -> Union[Tuple[str, bool, List[str]], None]:
        """
    ...
    @staticmethod
    def get_version_from_updates_server(cur_version: Version) -> None:
        """
