...
class MoveRequest(Request):
    ...
    _schema = {
        ...
        "properties": {
            ...
            "project_name": {
                "description": "Target project name. If provided and a project with this name does not exist, anew project will be created.If not provided, `project`must be provided.",
                "type": "string",
            },
        },
        "required": ["ids"],
