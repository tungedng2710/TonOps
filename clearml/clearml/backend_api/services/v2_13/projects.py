...
class DeleteRequest(Request):
    ...
    :type force: bool
    :param delete_contents: If set to 'true' then the project tasks and models will be deleted, otherwise their project property will be unassigned.
...
class MergeResponse(Response):
    ...
    :param moved_entities: The number of tasks, models and dataviews moved from the
        merged project into the destination
